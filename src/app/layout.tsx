...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="h-full" style={{ scrollBehavior: 'auto' }}>
      <body className={`${inter.className} min-h-full flex flex-col antialiased bg-gradient-to-b from-primary-100 via-background-light to-secondary-100 dark:from-primary-950 dark:via-background-dark dark:to-secondary-950 relative overflow-x-hidden`}>
