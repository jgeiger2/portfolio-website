...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="h-full" style={{ scrollBehavior: 'auto' }}>
      <body className={`${inter.className} min-h-full flex flex-col antialiased bg-gradient-to-b from-primary-100 via-background-light to-secondary-100 dark:bg-background relative overflow-x-hidden`}>
